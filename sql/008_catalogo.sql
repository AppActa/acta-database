...
('pdca', 'ciclo', 'id_ishikawa_mongo', 'UUID', FALSE, FALSE, NULL, FALSE, 'Chave de referência externa (MongoDB).', 'INTERNO', 'Identificador do diagrama de Ishikawa armazenado em base externa.'),
('pdca', 'ciclo', 'icone_url', TEXT, FALSE, FALSE, NULL, FALSE, 'URL única associada a URL do ícone no bucket.', 'PUBLICO', 'URL do ícone no Cloudinary.'),
...
('pdca', 'causa_raiz', 'id_5_porques_mongo', 'UUID', FALSE, FALSE, NULL, FALSE, 'Identificador de análise externa (MongoDB).', 'INTERNO', 'Identificador da análise dos 5 porquês armazenada em base externa.'),
